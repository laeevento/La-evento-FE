...
- `@laevento/components`: a stub React component library shared by both `web` and `docs` applications
- `@laevento/eslint-config`: `eslint` configurations (includes `eslint-config-next` and `eslint-config-prettier`)
- `@laevento/typescript-config`: `tsconfig.json`s used throughout the monorepo
